...
<div class="container ">
    ...
    <form class="w-50 m-auto signup" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        <div class="form-group">
            <label for="username">User Name</label>
            <input pattern=".{4,}" title="You Must write More 4 Charaters" type="text" class="form-control" name="username" id="username" autocomplete="off" required>
        </div>
        <div class="form-group">
            <label for="password1">Password</label>
            <input minlength="4" type="password" name="password1" class="form-control" id="password1" autocomplete="new-password" required>
        </div>
        <div class="form-group">
            <label for="password2">Repeat Password</label>
            <input type="password" class="form-control" name="password2" id="password2" autocomplete="new-password" required>
        </div>
        <div class="form-group">
